...
class Config(multiconfig.DefaultConfig):
    ...
    data_dir = os.path.join(os.environ['OPENSHIFT_DATA_DIR'], 'data', '') # path with trailing /

    # Where system and help pages are (you may exclude this from backup):
    data_underlay_dir = os.path.join(os.environ['OPENSHIFT_DATA_DIR'], 'underlay', '') # path with trailing /
